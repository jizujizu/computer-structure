...
//    assign Jrn = ((Opcode==6'b000000)? 1'b1:1'b0) & ((Function_opcode==6'b001000)? 1'b1:1'b0);

//    assign RegWrite = (R_format || Lw || Jal || I_format) && !(Jrn);
    
//    assign Sw = (Opcode==6'b101011)? 1'b1:1'b0;
//    assign ALUSrc = ((Opcode[5:3]==3'b001)||Opcode[5])? 1'b1:1'b0;
//    assign Branch = (Opcode==6'b000100)? 1'b1:1'b0;
//    assign nBranch = (Opcode==6'b000101)? 1'b1:1'b0;
//    assign Jmp = (Opcode==6'b000010)? 1'b1:1'b0;
    
//    assign MemWrite = ((Sw==1) && (Alu_resultHigh[21:0] != 22'b1111111111111111111111))? 1'b1:1'b0;
//    assign MemRead =  ((Lw==1) && (Alu_resultHigh[21:0] != 22'b1111111111111111111111))? 1'b1:1'b0; //读存储器
//    assign IOWrite =  ((Sw==1) && (Alu_resultHigh[21:0] == 22'b1111111111111111111111))? 1'b1:1'b0; //写端口
//    assign IORead =   ((Lw==1) && (Alu_resultHigh[21:0] == 22'b1111111111111111111111))? 1'b1:1'b0; //读端口
//    assign MemorIOtoReg =  IORead||MemRead ; //
    
//    assign MemtoReg = Lw;
//    assign Sftmd = ((Opcode==6'b000000)? 1'b1:1'b0)&((Function_opcode[5:3]==3'b000)? 1'b1:1'b0);
